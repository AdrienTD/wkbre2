...
TagDict<40> Tags::CBLUEPRINT_tagDict({
    "BLUEPRINT_TOOLTIP",
    "BUILDING_TYPE",
    "CAN_BUILD",
    "CAN_SPAWN",
...
TagDict<129> Tags::ACTION_tagDict({
    "ABANDON_PLAN",
    "ACTIVATE_COMMISSION",
    "ACTIVATE_PLAN",
    "ADD_REACTION",
    ...
    "INCREASE_ITEM",
    "INDICATE_POSITION_OF_MISSION_OBJECTIVES_ENTRY",
    ...
    "RESERVE_SPACE_FOR_CONSTRUCTION",
    "RESERVE_TILE_FOR_CONSTRUCTION",
    "REVEAL_FOG_OF_WAR",
    "SEND_CHAT_MESSAGE",
    "SEND_EVENT",
    "SEND_PACKAGE",
