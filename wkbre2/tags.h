...
const int CBLUEPRINT_MAP_TYPE_TAG = 16;
const int CBLUEPRINT_MISSILE_SPEED = 17;
const int CBLUEPRINT_MOVEMENT_BAND = 18;
const int CBLUEPRINT_MOVEMENT_SPEED_EQUATION = 19;
const int CBLUEPRINT_OFFERS_COMMAND = 20;
const int CBLUEPRINT_PHYSICAL_SUBTYPE = 21;
const int CBLUEPRINT_RECEIVE_SIGHT_RANGE_EVENTS = 22;
const int CBLUEPRINT_REPRESENT_AS = 23;
const int CBLUEPRINT_SCALE_APPEARANCE = 24;
const int CBLUEPRINT_SHOULD_PROCESS_SIGHT_RANGE = 25;
const int CBLUEPRINT_SIGHT_RANGE_EQUATION = 26;
const int CBLUEPRINT_STARTS_WITH_ITEM = 27;
const int CBLUEPRINT_STRIKE_FLOOR_SOUND = 28;
const int CBLUEPRINT_STRIKE_WATER_SOUND = 29;
const int CBLUEPRINT_USE_FOOTPRINT = 30;
const int CBLUEPRINT_COUNT = 31;
extern TagDict<31> CBLUEPRINT_tagDict;
