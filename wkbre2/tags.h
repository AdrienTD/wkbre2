...
const int POSITION_RANDOM_ATTACHMENT_POINT = 13;
const int POSITION_SPAWN_TILE_POSITION = 14;
const int POSITION_THE_OTHER_SIDE_OF = 15;
const int POSITION_THIS_SIDE_OF = 16;
const int POSITION_TOWARDS = 17;
const int POSITION_COUNT = 18;
extern TagDict<18> POSITION_tagDict;
