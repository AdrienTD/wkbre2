...
const int ACTION_DISABLE_DIPLOMATIC_REPORT_WINDOW = 32;
const int ACTION_DISABLE_GAME_INTERFACE = 33;
const int ACTION_DISABLE_TRIBUTES_WINDOW = 34;
const int ACTION_DISBAND_FORMATION = 35;
const int ACTION_DISPLAY_GAME_TEXT_WINDOW = 36;
const int ACTION_DISPLAY_LOAD_GAME_MENU = 37;
const int ACTION_ENABLE = 38;
const int ACTION_ENABLE_DIPLOMATIC_REPORT_WINDOW = 39;
const int ACTION_ENABLE_GAME_INTERFACE = 40;
const int ACTION_ENABLE_TRIBUTES_WINDOW = 41;
const int ACTION_EXECUTE_ONE_AT_RANDOM = 42;
const int ACTION_EXECUTE_SEQUENCE = 43;
const int ACTION_EXECUTE_SEQUENCE_AFTER_DELAY = 44;
const int ACTION_EXECUTE_SEQUENCE_OVER_PERIOD = 45;
const int ACTION_EXIT_TO_MAIN_MENU = 46;
const int ACTION_FACE_TOWARDS = 47;
const int ACTION_FADE_STOP_MUSIC = 48;
const int ACTION_FORCE_PLAY_MUSIC = 49;
const int ACTION_HIDE_CURRENT_GAME_TEXT_WINDOW = 50;
const int ACTION_HIDE_GAME_TEXT_WINDOW = 51;
const int ACTION_HIDE_MISSION_OBJECTIVES_ENTRY = 52;
const int ACTION_IDENTIFY_AND_MARK_CLUSTERS = 53;
const int ACTION_INCREASE_INDEXED_ITEM = 54;
const int ACTION_INCREASE_ITEM = 55;
const int ACTION_INDICATE_POSITION_OF_MISSION_OBJECTIVES_ENTRY = 56;
const int ACTION_INTERPOLATE_CAMERA_TO_POSITION = 57;
const int ACTION_INTERPOLATE_CAMERA_TO_STORED_POSITION = 58;
const int ACTION_LEAVE_FORMATION = 59;
const int ACTION_LOCK_TIME = 60;
const int ACTION_MAKE_DIPLOMATIC_OFFER = 61;
const int ACTION_PLAY_ANIMATION_IF_IDLE = 62;
const int ACTION_PLAY_CAMERA_PATH = 63;
const int ACTION_PLAY_CLIP = 64;
const int ACTION_PLAY_MUSIC = 65;
const int ACTION_PLAY_SOUND = 66;
const int ACTION_PLAY_SOUND_AT_POSITION = 67;
const int ACTION_PLAY_SPECIAL_EFFECT = 68;
const int ACTION_PLAY_SPECIAL_EFFECT_BETWEEN = 69;
const int ACTION_REEVALUATE_TASK_TARGET = 70;
const int ACTION_REGISTER_ASSOCIATES = 71;
const int ACTION_REGISTER_WORK_ORDER = 72;
const int ACTION_REMOVE = 73;
const int ACTION_REMOVE_MULTIPLAYER_PLAYER = 74;
const int ACTION_REMOVE_REACTION = 75;
const int ACTION_REPEAT_SEQUENCE = 76;
const int ACTION_REPEAT_SEQUENCE_OVER_PERIOD = 77;
const int ACTION_RESERVE_SPACE_FOR_CONSTRUCTION = 78;
const int ACTION_RESERVE_TILE_FOR_CONSTRUCTION = 79;
const int ACTION_REVEAL_FOG_OF_WAR = 80;
const int ACTION_SEND_CHAT_MESSAGE = 81;
const int ACTION_SEND_EVENT = 82;
const int ACTION_SEND_PACKAGE = 83;
const int ACTION_SET_ACTIVE_MISSION_OBJECTIVES = 84;
const int ACTION_SET_CHAT_PERSONALITY = 85;
const int ACTION_SET_INDEXED_ITEM = 86;
const int ACTION_SET_ITEM = 87;
const int ACTION_SET_RECONNAISSANCE = 88;
const int ACTION_SET_RENDERABLE = 89;
const int ACTION_SET_SCALE = 90;
const int ACTION_SET_SELECTABLE = 91;
const int ACTION_SET_TARGETABLE = 92;
const int ACTION_SHOW_BLINKING_DOT_ON_MINIMAP = 93;
const int ACTION_SHOW_MISSION_OBJECTIVES_ENTRY = 94;
const int ACTION_SHOW_MISSION_OBJECTIVES_ENTRY_INACTIVE = 95;
const int ACTION_SINK_AND_REMOVE = 96;
const int ACTION_SKIP_CAMERA_PATH_PLAYBACK = 97;
const int ACTION_SNAP_CAMERA_TO_POSITION = 98;
const int ACTION_SNAP_CAMERA_TO_STORED_POSITION = 99;
const int ACTION_STOP_CAMERA_PATH_PLAYBACK = 100;
const int ACTION_STOP_INDICATING_POSITION_OF_MISSION_OBJECTIVES_ENTRY = 101;
const int ACTION_STOP_SOUND = 102;
const int ACTION_STORE_CAMERA_POSITION = 103;
const int ACTION_SWITCH_APPEARANCE = 104;
const int ACTION_SWITCH_CONDITION = 105;
const int ACTION_SWITCH_HIGHEST = 106;
const int ACTION_SWITCH_ON_INTENSITY_MAP = 107;
const int ACTION_TELEPORT = 108;
const int ACTION_TERMINATE = 109;
const int ACTION_TERMINATE_ORDER = 110;
const int ACTION_TERMINATE_TASK = 111;
const int ACTION_TERMINATE_THIS_ORDER = 112;
const int ACTION_TERMINATE_THIS_TASK = 113;
const int ACTION_TRACE = 114;
const int ACTION_TRACE_FINDER_RESULTS = 115;
const int ACTION_TRACE_VALUE = 116;
const int ACTION_TRACK_OBJECT_POSITION_FROM_MISSION_OBJECTIVES_ENTRY = 117;
const int ACTION_TRANSFER_CONTROL = 118;
const int ACTION_UNASSIGN_ALIAS = 119;
const int ACTION_UNLOCK_LEVEL = 120;
const int ACTION_UNLOCK_TIME = 121;
const int ACTION_UPDATE_USER_PROFILE = 122;
const int ACTION_UPON_CONDITION = 123;
const int ACTION_COUNT = 124;
extern TagDict<124> ACTION_tagDict;
