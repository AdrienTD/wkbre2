...
const int CBLUEPRINT_REPRESENT_AS = 24;
const int CBLUEPRINT_SCALE_APPEARANCE = 25;
const int CBLUEPRINT_SHOULD_PROCESS_SIGHT_RANGE = 26;
const int CBLUEPRINT_SIGHT_RANGE_EQUATION = 27;
const int CBLUEPRINT_STARTS_WITH_ITEM = 28;
const int CBLUEPRINT_STRIKE_FLOOR_SOUND = 29;
const int CBLUEPRINT_STRIKE_WATER_SOUND = 30;
const int CBLUEPRINT_USE_FOOTPRINT = 31;
const int CBLUEPRINT_VARY_X_SCALE = 32;
const int CBLUEPRINT_VARY_Y_SCALE = 33;
const int CBLUEPRINT_VARY_Z_SCALE = 34;
const int CBLUEPRINT_COUNT = 35;
extern TagDict<35> CBLUEPRINT_tagDict;
