...
const int CBLUEPRINT_OBJECT_IS_RENDERABLE = 22;
const int CBLUEPRINT_OBJECT_IS_SELECTABLE = 23;
const int CBLUEPRINT_OBJECT_IS_TARGETABLE = 24;
const int CBLUEPRINT_OFFERS_COMMAND = 25;
const int CBLUEPRINT_PHYSICAL_SUBTYPE = 26;
const int CBLUEPRINT_RECEIVE_SIGHT_RANGE_EVENTS = 27;
const int CBLUEPRINT_REMOVE_WHEN_NOT_REFERENCED = 28;
const int CBLUEPRINT_REPRESENT_AS = 29;
const int CBLUEPRINT_SCALE_APPEARANCE = 30;
const int CBLUEPRINT_SHOULD_PROCESS_SIGHT_RANGE = 31;
const int CBLUEPRINT_SIGHT_RANGE_EQUATION = 32;
const int CBLUEPRINT_STARTS_WITH_ITEM = 33;
const int CBLUEPRINT_STRIKE_FLOOR_SOUND = 34;
const int CBLUEPRINT_STRIKE_WATER_SOUND = 35;
const int CBLUEPRINT_USE_FOOTPRINT = 36;
const int CBLUEPRINT_VARY_X_SCALE = 37;
const int CBLUEPRINT_VARY_Y_SCALE = 38;
const int CBLUEPRINT_VARY_Z_SCALE = 39;
const int CBLUEPRINT_COUNT = 40;
extern TagDict<40> CBLUEPRINT_tagDict;
...
const int POSITION_BEHIND = 2;
const int POSITION_CENTRE_OF_MAP = 3;
const int POSITION_DESTINATION_OF = 4;
const int POSITION_FIRING_ATTACHMENT_POINT = 5;
const int POSITION_IN_FRONT_OF = 6;
const int POSITION_LOCATION_OF = 7;
const int POSITION_MATCHING_OFFSET = 8;
const int POSITION_NEAREST_ATTACHMENT_POINT = 9;
const int POSITION_NEAREST_CONSTRUCTION_SITE = 10;
const int POSITION_NEAREST_VALID_POSITION_FOR = 11;
const int POSITION_NEAREST_VALID_STAMPDOWN_POS = 12;
const int POSITION_OFFSET_FROM = 13;
const int POSITION_OUT_AT_ANGLE = 14;
const int POSITION_RANDOM_ATTACHMENT_POINT = 15;
const int POSITION_SPAWN_TILE_POSITION = 16;
const int POSITION_THE_OTHER_SIDE_OF = 17;
const int POSITION_THIS_SIDE_OF = 18;
const int POSITION_TOWARDS = 19;
const int POSITION_COUNT = 20;
extern TagDict<20> POSITION_tagDict;
...
const int PDITEM_FOOD_COST = 2;
const int PDITEM_GOLD = 3;
const int PDITEM_GOLD_COST = 4;
const int PDITEM_HIT_POINTS = 5;
const int PDITEM_HIT_POINTS_OF_OBJECT_BEING_SPAWNED = 6;
const int PDITEM_HIT_POINT_CAPACITY = 7;
const int PDITEM_HIT_POINT_CAPACITY_OF_OBJECT_BEING_SPAWNED = 8;
const int PDITEM_NUMBER_OF_FARMERS = 9;
const int PDITEM_STONE = 10;
const int PDITEM_WOOD = 11;
const int PDITEM_WOOD_COST = 12;
const int PDITEM_COUNT = 13;
extern TagDict<13> PDITEM_tagDict;
