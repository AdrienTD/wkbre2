...
const int CBLUEPRINT_MAP_MUSIC_TAG = 11;
const int CBLUEPRINT_MAP_SOUND_TAG = 12;
const int CBLUEPRINT_MAP_SOUND_TAG_TO = 13;
const int CBLUEPRINT_MAP_TYPE_TAG = 14;
const int CBLUEPRINT_MISSILE_SPEED = 15;
const int CBLUEPRINT_MOVEMENT_BAND = 16;
const int CBLUEPRINT_MOVEMENT_SPEED_EQUATION = 17;
const int CBLUEPRINT_OFFERS_COMMAND = 18;
const int CBLUEPRINT_PHYSICAL_SUBTYPE = 19;
const int CBLUEPRINT_REPRESENT_AS = 20;
const int CBLUEPRINT_SCALE_APPEARANCE = 21;
const int CBLUEPRINT_SIGHT_RANGE_EQUATION = 22;
const int CBLUEPRINT_STARTS_WITH_ITEM = 23;
const int CBLUEPRINT_USE_FOOTPRINT = 24;
const int CBLUEPRINT_COUNT = 25;
extern TagDict<25> CBLUEPRINT_tagDict;
