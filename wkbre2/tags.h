...
const int ACTION_ACTIVATE_PLAN = 1;
const int ACTION_ADD_REACTION = 2;
const int ACTION_ADOPT_APPEARANCE_FOR = 3;
const int ACTION_ADOPT_DEFAULT_APPEARANCE_FOR = 4;
const int ACTION_ASSIGN_ALIAS = 5;
const int ACTION_ASSIGN_ORDER_VIA = 6;
const int ACTION_ATTACH_LOOPING_SPECIAL_EFFECT = 7;
const int ACTION_ATTACH_SPECIAL_EFFECT = 8;
const int ACTION_BOOT_LEVEL = 9;
const int ACTION_CANCEL_ORDER = 10;
const int ACTION_CHANGE_DIPLOMATIC_STATUS = 11;
const int ACTION_CHANGE_REACTION_PROFILE = 12;
const int ACTION_CLEAR_ALIAS = 13;
const int ACTION_CLEAR_ASSOCIATES = 14;
const int ACTION_COLLAPSING_CIRCLE_ON_MINIMAP = 15;
const int ACTION_CONQUER_LEVEL = 16;
const int ACTION_CONVERT_ACCORDING_TO_TAG = 17;
const int ACTION_CONVERT_TO = 18;
const int ACTION_COPY_FACING_OF = 19;
const int ACTION_CREATE_FORMATION = 20;
const int ACTION_CREATE_FORMATION_REFERENCE = 21;
const int ACTION_CREATE_OBJECT = 22;
const int ACTION_CREATE_OBJECT_VIA = 23;
const int ACTION_DEACTIVATE_COMMISSION = 24;
const int ACTION_DECLINE_DIPLOMATIC_OFFER = 25;
const int ACTION_DECREASE_INDEXED_ITEM = 26;
const int ACTION_DECREASE_ITEM = 27;
const int ACTION_DEREGISTER_ASSOCIATES = 28;
const int ACTION_DETACH_LOOPING_SPECIAL_EFFECT = 29;
const int ACTION_DISABLE = 30;
const int ACTION_DISABLE_DIPLOMATIC_REPORT_WINDOW = 31;
const int ACTION_DISABLE_GAME_INTERFACE = 32;
const int ACTION_DISABLE_TRIBUTES_WINDOW = 33;
const int ACTION_DISBAND_FORMATION = 34;
const int ACTION_DISPLAY_GAME_TEXT_WINDOW = 35;
const int ACTION_DISPLAY_LOAD_GAME_MENU = 36;
const int ACTION_ENABLE = 37;
const int ACTION_ENABLE_DIPLOMATIC_REPORT_WINDOW = 38;
const int ACTION_ENABLE_GAME_INTERFACE = 39;
const int ACTION_ENABLE_TRIBUTES_WINDOW = 40;
const int ACTION_EXECUTE_ONE_AT_RANDOM = 41;
const int ACTION_EXECUTE_SEQUENCE = 42;
const int ACTION_EXECUTE_SEQUENCE_AFTER_DELAY = 43;
const int ACTION_EXECUTE_SEQUENCE_OVER_PERIOD = 44;
const int ACTION_EXIT_TO_MAIN_MENU = 45;
const int ACTION_FACE_TOWARDS = 46;
const int ACTION_FADE_STOP_MUSIC = 47;
const int ACTION_FORCE_PLAY_MUSIC = 48;
const int ACTION_HIDE_CURRENT_GAME_TEXT_WINDOW = 49;
const int ACTION_HIDE_GAME_TEXT_WINDOW = 50;
const int ACTION_HIDE_MISSION_OBJECTIVES_ENTRY = 51;
const int ACTION_IDENTIFY_AND_MARK_CLUSTERS = 52;
const int ACTION_INCREASE_INDEXED_ITEM = 53;
const int ACTION_INCREASE_ITEM = 54;
const int ACTION_INDICATE_POSITION_OF_MISSION_OBJECTIVES_ENTRY = 55;
const int ACTION_INTERPOLATE_CAMERA_TO_POSITION = 56;
const int ACTION_INTERPOLATE_CAMERA_TO_STORED_POSITION = 57;
const int ACTION_LEAVE_FORMATION = 58;
const int ACTION_LOCK_TIME = 59;
const int ACTION_MAKE_DIPLOMATIC_OFFER = 60;
const int ACTION_PLAY_ANIMATION_IF_IDLE = 61;
const int ACTION_PLAY_CAMERA_PATH = 62;
const int ACTION_PLAY_CLIP = 63;
const int ACTION_PLAY_MUSIC = 64;
const int ACTION_PLAY_SOUND = 65;
const int ACTION_PLAY_SOUND_AT_POSITION = 66;
const int ACTION_PLAY_SPECIAL_EFFECT = 67;
const int ACTION_PLAY_SPECIAL_EFFECT_BETWEEN = 68;
const int ACTION_REEVALUATE_TASK_TARGET = 69;
const int ACTION_REGISTER_ASSOCIATES = 70;
const int ACTION_REMOVE = 71;
const int ACTION_REMOVE_MULTIPLAYER_PLAYER = 72;
const int ACTION_REMOVE_REACTION = 73;
const int ACTION_REPEAT_SEQUENCE = 74;
const int ACTION_REPEAT_SEQUENCE_OVER_PERIOD = 75;
const int ACTION_REVEAL_FOG_OF_WAR = 76;
const int ACTION_SEND_CHAT_MESSAGE = 77;
const int ACTION_SEND_EVENT = 78;
const int ACTION_SEND_PACKAGE = 79;
const int ACTION_SET_ACTIVE_MISSION_OBJECTIVES = 80;
const int ACTION_SET_CHAT_PERSONALITY = 81;
const int ACTION_SET_INDEXED_ITEM = 82;
const int ACTION_SET_ITEM = 83;
const int ACTION_SET_RECONNAISSANCE = 84;
const int ACTION_SET_RENDERABLE = 85;
const int ACTION_SET_SCALE = 86;
const int ACTION_SET_SELECTABLE = 87;
const int ACTION_SET_TARGETABLE = 88;
const int ACTION_SHOW_BLINKING_DOT_ON_MINIMAP = 89;
const int ACTION_SHOW_MISSION_OBJECTIVES_ENTRY = 90;
const int ACTION_SHOW_MISSION_OBJECTIVES_ENTRY_INACTIVE = 91;
const int ACTION_SINK_AND_REMOVE = 92;
const int ACTION_SKIP_CAMERA_PATH_PLAYBACK = 93;
const int ACTION_SNAP_CAMERA_TO_POSITION = 94;
const int ACTION_SNAP_CAMERA_TO_STORED_POSITION = 95;
const int ACTION_STOP_CAMERA_PATH_PLAYBACK = 96;
const int ACTION_STOP_INDICATING_POSITION_OF_MISSION_OBJECTIVES_ENTRY = 97;
const int ACTION_STOP_SOUND = 98;
const int ACTION_STORE_CAMERA_POSITION = 99;
const int ACTION_SWITCH_APPEARANCE = 100;
const int ACTION_SWITCH_CONDITION = 101;
const int ACTION_SWITCH_HIGHEST = 102;
const int ACTION_SWITCH_ON_INTENSITY_MAP = 103;
const int ACTION_TELEPORT = 104;
const int ACTION_TERMINATE = 105;
const int ACTION_TERMINATE_ORDER = 106;
const int ACTION_TERMINATE_TASK = 107;
const int ACTION_TERMINATE_THIS_ORDER = 108;
const int ACTION_TERMINATE_THIS_TASK = 109;
const int ACTION_TRACE = 110;
const int ACTION_TRACE_FINDER_RESULTS = 111;
const int ACTION_TRACE_VALUE = 112;
const int ACTION_TRACK_OBJECT_POSITION_FROM_MISSION_OBJECTIVES_ENTRY = 113;
const int ACTION_TRANSFER_CONTROL = 114;
const int ACTION_UNASSIGN_ALIAS = 115;
const int ACTION_UNLOCK_LEVEL = 116;
const int ACTION_UNLOCK_TIME = 117;
const int ACTION_UPDATE_USER_PROFILE = 118;
const int ACTION_UPON_CONDITION = 119;
const int ACTION_COUNT = 120;
extern TagDict<120> ACTION_tagDict;
