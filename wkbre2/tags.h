...
const int VALUE_BLUEPRINT_ITEM_VALUE = 4;
const int VALUE_BUILDING_TYPE = 5;
const int VALUE_BUILDING_TYPE_OPERAND = 6;
const int VALUE_CAN_AFFORD_COMMISSION = 7;
const int VALUE_CAN_REACH = 8;
const int VALUE_CAN_TRAVERSE_NEIGHBOURING_TILE = 9;
const int VALUE_CONSTANT = 10;
const int VALUE_COULD_REACH = 11;
const int VALUE_CURRENTLY_DOING_ORDER = 12;
const int VALUE_CURRENTLY_DOING_TASK = 13;
const int VALUE_DEFINED_VALUE = 14;
const int VALUE_DIPLOMATIC_STATUS_AT_LEAST = 15;
const int VALUE_DISTANCE_BETWEEN = 16;
const int VALUE_DISTANCE_BETWEEN_INCLUDING_RADIUS = 17;
const int VALUE_EQUATION_RESULT = 18;
const int VALUE_FINDER_RESULTS_COUNT = 19;
const int VALUE_GRADIENT_IN_FRONT = 20;
const int VALUE_HAS_APPEARANCE = 21;
const int VALUE_HAS_DIRECT_LINE_OF_SIGHT_TO = 22;
const int VALUE_INDEXED_ITEM_VALUE = 23;
const int VALUE_IS_ACCESSIBLE = 24;
const int VALUE_IS_DISABLED = 25;
const int VALUE_IS_DISCOVERED = 26;
const int VALUE_IS_IDLE = 27;
const int VALUE_IS_MUSIC_PLAYING = 28;
const int VALUE_IS_SUBSET_OF = 29;
const int VALUE_IS_VISIBLE = 30;
const int VALUE_ITEM_VALUE = 31;
const int VALUE_MAP_DEPTH = 32;
const int VALUE_MAP_WIDTH = 33;
const int VALUE_NUM_ASSOCIATES = 34;
const int VALUE_NUM_ASSOCIATORS = 35;
const int VALUE_NUM_OBJECTS = 36;
const int VALUE_NUM_ORDERS = 37;
const int VALUE_NUM_REFERENCERS = 38;
const int VALUE_OBJECT_CLASS = 39;
const int VALUE_OBJECT_ID = 40;
const int VALUE_OBJECT_TYPE = 41;
const int VALUE_SAME_PLAYER = 42;
const int VALUE_TILE_ITEM = 43;
const int VALUE_TOTAL_ITEM_VALUE = 44;
const int VALUE_VALUE_TAG_INTERPRETATION = 45;
const int VALUE_WATER_BENEATH = 46;
const int VALUE_WITHIN_FORWARD_ARC = 47;
const int VALUE_COUNT = 48;
extern TagDict<48> VALUE_tagDict;
...
const int ACTION_REGISTER_WORK_ORDER = 71;
const int ACTION_REMOVE = 72;
const int ACTION_REMOVE_MULTIPLAYER_PLAYER = 73;
const int ACTION_REMOVE_REACTION = 74;
const int ACTION_REPEAT_SEQUENCE = 75;
const int ACTION_REPEAT_SEQUENCE_OVER_PERIOD = 76;
const int ACTION_RESERVE_SPACE_FOR_CONSTRUCTION = 77;
const int ACTION_RESERVE_TILE_FOR_CONSTRUCTION = 78;
const int ACTION_REVEAL_FOG_OF_WAR = 79;
const int ACTION_SEND_CHAT_MESSAGE = 80;
const int ACTION_SEND_EVENT = 81;
const int ACTION_SEND_PACKAGE = 82;
const int ACTION_SET_ACTIVE_MISSION_OBJECTIVES = 83;
const int ACTION_SET_CHAT_PERSONALITY = 84;
const int ACTION_SET_INDEXED_ITEM = 85;
const int ACTION_SET_ITEM = 86;
const int ACTION_SET_RECONNAISSANCE = 87;
const int ACTION_SET_RENDERABLE = 88;
const int ACTION_SET_SCALE = 89;
const int ACTION_SET_SELECTABLE = 90;
const int ACTION_SET_TARGETABLE = 91;
const int ACTION_SHOW_BLINKING_DOT_ON_MINIMAP = 92;
const int ACTION_SHOW_MISSION_OBJECTIVES_ENTRY = 93;
const int ACTION_SHOW_MISSION_OBJECTIVES_ENTRY_INACTIVE = 94;
const int ACTION_SINK_AND_REMOVE = 95;
const int ACTION_SKIP_CAMERA_PATH_PLAYBACK = 96;
const int ACTION_SNAP_CAMERA_TO_POSITION = 97;
const int ACTION_SNAP_CAMERA_TO_STORED_POSITION = 98;
const int ACTION_STOP_CAMERA_PATH_PLAYBACK = 99;
const int ACTION_STOP_INDICATING_POSITION_OF_MISSION_OBJECTIVES_ENTRY = 100;
const int ACTION_STOP_SOUND = 101;
const int ACTION_STORE_CAMERA_POSITION = 102;
const int ACTION_SWITCH_APPEARANCE = 103;
const int ACTION_SWITCH_CONDITION = 104;
const int ACTION_SWITCH_HIGHEST = 105;
const int ACTION_SWITCH_ON_INTENSITY_MAP = 106;
const int ACTION_TELEPORT = 107;
const int ACTION_TERMINATE = 108;
const int ACTION_TERMINATE_ORDER = 109;
const int ACTION_TERMINATE_TASK = 110;
const int ACTION_TERMINATE_THIS_ORDER = 111;
const int ACTION_TERMINATE_THIS_TASK = 112;
const int ACTION_TRACE = 113;
const int ACTION_TRACE_FINDER_RESULTS = 114;
const int ACTION_TRACE_VALUE = 115;
const int ACTION_TRACK_OBJECT_POSITION_FROM_MISSION_OBJECTIVES_ENTRY = 116;
const int ACTION_TRANSFER_CONTROL = 117;
const int ACTION_UNASSIGN_ALIAS = 118;
const int ACTION_UNLOCK_LEVEL = 119;
const int ACTION_UNLOCK_TIME = 120;
const int ACTION_UPDATE_USER_PROFILE = 121;
const int ACTION_UPON_CONDITION = 122;
const int ACTION_COUNT = 123;
extern TagDict<123> ACTION_tagDict;
