...
const int PDEVENT_ON_IDLE = 5;
const int PDEVENT_ON_LEVEL_START = 6;
const int PDEVENT_ON_OBJECT_ENTERS = 7;
const int PDEVENT_ON_OBJECT_EXITS = 8;
const int PDEVENT_ON_SEEING_OBJECT = 9;
const int PDEVENT_ON_SHARE_TILE = 10;
const int PDEVENT_ON_SPAWN = 11;
const int PDEVENT_ON_STAMPDOWN = 12;
const int PDEVENT_ON_STOP_SEEING_OBJECT = 13;
const int PDEVENT_ON_SUBORDINATE_RECEIVED = 14;
const int PDEVENT_ON_TERMINATION = 15;
const int PDEVENT_COUNT = 16;
extern TagDict<16> PDEVENT_tagDict;
