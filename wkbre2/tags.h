...
const int GAMESET_SOUND = 59;
const int GAMESET_SOUND_TAG = 60;
const int GAMESET_TASK = 61;
const int GAMESET_TASK_CATEGORY = 62;
const int GAMESET_TERRAIN_ZONE = 63;
const int GAMESET_TOWN = 64;
const int GAMESET_TOWN_EXTENSION = 65;
const int GAMESET_TYPE_TAG = 66;
const int GAMESET_USER = 67;
const int GAMESET_USER_EXTENSION = 68;
const int GAMESET_VALUE_TAG = 69;
const int GAMESET_WORK_ORDER = 70;
const int GAMESET_COUNT = 71;
extern TagDict<71> GAMESET_tagDict;
...
const int CBLUEPRINT_MAP_SOUND_TAG_TO = 12;
const int CBLUEPRINT_MAP_TYPE_TAG = 13;
const int CBLUEPRINT_MISSILE_SPEED = 14;
const int CBLUEPRINT_MOVEMENT_BAND = 15;
const int CBLUEPRINT_MOVEMENT_SPEED_EQUATION = 16;
const int CBLUEPRINT_OFFERS_COMMAND = 17;
const int CBLUEPRINT_PHYSICAL_SUBTYPE = 18;
const int CBLUEPRINT_REPRESENT_AS = 19;
const int CBLUEPRINT_SCALE_APPEARANCE = 20;
const int CBLUEPRINT_SIGHT_RANGE_EQUATION = 21;
const int CBLUEPRINT_STARTS_WITH_ITEM = 22;
const int CBLUEPRINT_USE_FOOTPRINT = 23;
const int CBLUEPRINT_COUNT = 24;
extern TagDict<24> CBLUEPRINT_tagDict;
