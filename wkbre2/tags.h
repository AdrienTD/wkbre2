...
const int PDEVENT_ON_LAST_SUBORDINATE_RELEASED = 6;
const int PDEVENT_ON_LEVEL_START = 7;
const int PDEVENT_ON_OBJECT_ENTERS = 8;
const int PDEVENT_ON_OBJECT_EXITS = 9;
const int PDEVENT_ON_SEEING_OBJECT = 10;
const int PDEVENT_ON_SHARE_TILE = 11;
const int PDEVENT_ON_SPAWN = 12;
const int PDEVENT_ON_STAMPDOWN = 13;
const int PDEVENT_ON_STOP_SEEING_OBJECT = 14;
const int PDEVENT_ON_SUBORDINATE_RECEIVED = 15;
const int PDEVENT_ON_TERMINATION = 16;
const int PDEVENT_COUNT = 17;
extern TagDict<17> PDEVENT_tagDict;
