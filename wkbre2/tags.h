...
const int GAMESET_GLOBAL_SPECIAL_EFFECT_MAPPING = 35;
const int GAMESET_INDEV_ACTION_SEQUENCE = 36;
const int GAMESET_INDEV_EQUATION = 37;
const int GAMESET_INDEV_OBJECT_FINDER_DEFINITION = 38;
const int GAMESET_INDIVIDUAL_ITEM = 39;
const int GAMESET_LEVEL = 40;
const int GAMESET_LEVEL_EXTENSION = 41;
const int GAMESET_LINK_GAME_SET = 42;
const int GAMESET_MARKER = 43;
const int GAMESET_MARKER_EXTENSION = 44;
const int GAMESET_MISSILE = 45;
const int GAMESET_MISSILE_EXTENSION = 46;
const int GAMESET_MUSIC_TAG = 47;
const int GAMESET_OBJECT_CREATION = 48;
const int GAMESET_OBJECT_FINDER_DEFINITION = 49;
const int GAMESET_ORDER = 50;
const int GAMESET_ORDER_ASSIGNMENT = 51;
const int GAMESET_ORDER_CATEGORY = 52;
const int GAMESET_PACKAGE = 53;
const int GAMESET_PACKAGE_RECEIPT_TRIGGER = 54;
const int GAMESET_PASSABILITY_FIELDS = 55;
const int GAMESET_PLAN = 56;
const int GAMESET_PLAYER = 57;
const int GAMESET_PLAYER_EXTENSION = 58;
const int GAMESET_PROP = 59;
const int GAMESET_PROP_EXTENSION = 60;
const int GAMESET_REACTION = 61;
const int GAMESET_SOUND = 62;
const int GAMESET_SOUND_TAG = 63;
const int GAMESET_SPECIAL_EFFECT_TAG = 64;
const int GAMESET_TASK = 65;
const int GAMESET_TASK_CATEGORY = 66;
const int GAMESET_TERRAIN = 67;
const int GAMESET_TERRAIN_BLUEPRINT_LIST = 68;
const int GAMESET_TERRAIN_ZONE = 69;
const int GAMESET_TOWN = 70;
const int GAMESET_TOWN_EXTENSION = 71;
const int GAMESET_TYPE_TAG = 72;
const int GAMESET_USER = 73;
const int GAMESET_USER_EXTENSION = 74;
const int GAMESET_VALUE_TAG = 75;
const int GAMESET_WORK_ORDER = 76;
const int GAMESET_COUNT = 77;
extern TagDict<77> GAMESET_tagDict;
...
const int CBLUEPRINT_DO_NOT_COLLIDE_WITH = 4;
const int CBLUEPRINT_FLOATS_ON_WATER = 5;
const int CBLUEPRINT_GENERATE_SIGHT_RANGE_EVENTS = 6;
const int CBLUEPRINT_HAS_DYNAMIC_SHADOW = 7;
const int CBLUEPRINT_HAS_STATIC_SHADOW = 8;
const int CBLUEPRINT_INHERITS_FROM = 9;
const int CBLUEPRINT_INTERPRET_VALUE_TAG_AS = 10;
const int CBLUEPRINT_INTRINSIC_REACTION = 11;
const int CBLUEPRINT_ITEM = 12;
const int CBLUEPRINT_MAP_MUSIC_TAG = 13;
const int CBLUEPRINT_MAP_SOUND_TAG = 14;
const int CBLUEPRINT_MAP_SOUND_TAG_TO = 15;
const int CBLUEPRINT_MAP_SPECIAL_EFFECT_TAG = 16;
const int CBLUEPRINT_MAP_TYPE_TAG = 17;
const int CBLUEPRINT_MISSILE_SPEED = 18;
const int CBLUEPRINT_MOVEMENT_BAND = 19;
const int CBLUEPRINT_MOVEMENT_SPEED_EQUATION = 20;
const int CBLUEPRINT_OFFERS_COMMAND = 21;
const int CBLUEPRINT_PHYSICAL_SUBTYPE = 22;
const int CBLUEPRINT_RECEIVE_SIGHT_RANGE_EVENTS = 23;
const int CBLUEPRINT_REMOVE_WHEN_NOT_REFERENCED = 24;
const int CBLUEPRINT_REPRESENT_AS = 25;
const int CBLUEPRINT_SCALE_APPEARANCE = 26;
const int CBLUEPRINT_SHOULD_PROCESS_SIGHT_RANGE = 27;
const int CBLUEPRINT_SIGHT_RANGE_EQUATION = 28;
const int CBLUEPRINT_STARTS_WITH_ITEM = 29;
const int CBLUEPRINT_STRIKE_FLOOR_SOUND = 30;
const int CBLUEPRINT_STRIKE_WATER_SOUND = 31;
const int CBLUEPRINT_USE_FOOTPRINT = 32;
const int CBLUEPRINT_VARY_X_SCALE = 33;
const int CBLUEPRINT_VARY_Y_SCALE = 34;
const int CBLUEPRINT_VARY_Z_SCALE = 35;
const int CBLUEPRINT_COUNT = 36;
extern TagDict<36> CBLUEPRINT_tagDict;
...
const int ACTION_INDICATE_POSITION_OF_MISSION_OBJECTIVES_ENTRY = 54;
const int ACTION_INTERPOLATE_CAMERA_TO_POSITION = 55;
const int ACTION_INTERPOLATE_CAMERA_TO_STORED_POSITION = 56;
const int ACTION_LEAVE_FORMATION = 57;
const int ACTION_LOCK_TIME = 58;
const int ACTION_MAKE_DIPLOMATIC_OFFER = 59;
const int ACTION_PLAY_ANIMATION_IF_IDLE = 60;
const int ACTION_PLAY_CAMERA_PATH = 61;
const int ACTION_PLAY_CLIP = 62;
const int ACTION_PLAY_MUSIC = 63;
const int ACTION_PLAY_SOUND = 64;
const int ACTION_PLAY_SOUND_AT_POSITION = 65;
const int ACTION_PLAY_SPECIAL_EFFECT = 66;
const int ACTION_PLAY_SPECIAL_EFFECT_BETWEEN = 67;
const int ACTION_REEVALUATE_TASK_TARGET = 68;
const int ACTION_REGISTER_ASSOCIATES = 69;
const int ACTION_REMOVE = 70;
const int ACTION_REMOVE_MULTIPLAYER_PLAYER = 71;
const int ACTION_REMOVE_REACTION = 72;
const int ACTION_REPEAT_SEQUENCE = 73;
const int ACTION_REPEAT_SEQUENCE_OVER_PERIOD = 74;
const int ACTION_REVEAL_FOG_OF_WAR = 75;
const int ACTION_SEND_CHAT_MESSAGE = 76;
const int ACTION_SEND_EVENT = 77;
const int ACTION_SEND_PACKAGE = 78;
const int ACTION_SET_ACTIVE_MISSION_OBJECTIVES = 79;
const int ACTION_SET_CHAT_PERSONALITY = 80;
const int ACTION_SET_INDEXED_ITEM = 81;
const int ACTION_SET_ITEM = 82;
const int ACTION_SET_RECONNAISSANCE = 83;
const int ACTION_SET_RENDERABLE = 84;
const int ACTION_SET_SCALE = 85;
const int ACTION_SET_SELECTABLE = 86;
const int ACTION_SET_TARGETABLE = 87;
const int ACTION_SHOW_BLINKING_DOT_ON_MINIMAP = 88;
const int ACTION_SHOW_MISSION_OBJECTIVES_ENTRY = 89;
const int ACTION_SHOW_MISSION_OBJECTIVES_ENTRY_INACTIVE = 90;
const int ACTION_SINK_AND_REMOVE = 91;
const int ACTION_SKIP_CAMERA_PATH_PLAYBACK = 92;
const int ACTION_SNAP_CAMERA_TO_POSITION = 93;
const int ACTION_SNAP_CAMERA_TO_STORED_POSITION = 94;
const int ACTION_STOP_CAMERA_PATH_PLAYBACK = 95;
const int ACTION_STOP_INDICATING_POSITION_OF_MISSION_OBJECTIVES_ENTRY = 96;
const int ACTION_STOP_SOUND = 97;
const int ACTION_STORE_CAMERA_POSITION = 98;
const int ACTION_SWITCH_APPEARANCE = 99;
const int ACTION_SWITCH_CONDITION = 100;
const int ACTION_SWITCH_HIGHEST = 101;
const int ACTION_SWITCH_ON_INTENSITY_MAP = 102;
const int ACTION_TELEPORT = 103;
const int ACTION_TERMINATE = 104;
const int ACTION_TERMINATE_ORDER = 105;
const int ACTION_TERMINATE_TASK = 106;
const int ACTION_TERMINATE_THIS_ORDER = 107;
const int ACTION_TERMINATE_THIS_TASK = 108;
const int ACTION_TRACE = 109;
const int ACTION_TRACE_FINDER_RESULTS = 110;
const int ACTION_TRACE_VALUE = 111;
const int ACTION_TRACK_OBJECT_POSITION_FROM_MISSION_OBJECTIVES_ENTRY = 112;
const int ACTION_TRANSFER_CONTROL = 113;
const int ACTION_UNASSIGN_ALIAS = 114;
const int ACTION_UNLOCK_LEVEL = 115;
const int ACTION_UNLOCK_TIME = 116;
const int ACTION_UPDATE_USER_PROFILE = 117;
const int ACTION_UPON_CONDITION = 118;
const int ACTION_COUNT = 119;
extern TagDict<119> ACTION_tagDict;
...
const int PDEVENT_ON_OBJECT_EXITS = 7;
const int PDEVENT_ON_SEEING_OBJECT = 8;
const int PDEVENT_ON_SHARE_TILE = 9;
const int PDEVENT_ON_SPAWN = 10;
const int PDEVENT_ON_STAMPDOWN = 11;
const int PDEVENT_ON_STOP_SEEING_OBJECT = 12;
const int PDEVENT_ON_SUBORDINATE_RECEIVED = 13;
const int PDEVENT_ON_TERMINATION = 14;
const int PDEVENT_COUNT = 15;
extern TagDict<15> PDEVENT_tagDict;
